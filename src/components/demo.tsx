    ...
    <section id="demo" className="py-24 px-8 bg-white/[0.02]">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-light text-white mb-4">See it in action</h2>
        ...
        <div className="grid grid-cols-3 gap-6 mt-12">
          <div className="col-span-3 md:col-span-1 flex flex-col items-center text-center p-6">
            ...
            <p className="text-sm text-white/60">Link your GitHub repository with a single click</p>
          </div>
          ...
          <div className="col-span-3 md:col-span-1 flex flex-col items-center text-center p-6">
            ...
            <p className="text-sm text-white/60">Our AI analyzes your code and creates the perfect README</p>
          </div>
          ...
          <div className="col-span-3 md:col-span-1 flex flex-col items-center text-center p-6">
            ...
            <p className="text-sm text-white/60">Edit if needed and publish directly to your repository</p>
          </div>
        </div>
      </div>
    </section>
